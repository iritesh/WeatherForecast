    ...
    return {
        ...
        link: function(scope, element) {
            ...
            var recalculate = function() {
                console.log('coming in recalculate');
                ifVertElseHor(function() {
                    console.log('in vertical');
                    child.css('height', 'auto');
                    var liLength=0;
                if(Sizzle('ul.dropdown-menu').length >0)
                   liLength = Sizzle('ul.dropdown-menu')[0].offsetWidth;

                    length = (child[0].scrollHeight + liLength) || 0;
                }, null)();
